...
## 7.1 산술 연산자 오버로딩
코틀린에서 관례를 사용하는 가장 단순한 예는 산술 연산자다. 자바에서는 원시 타입에 대해서만 산술 연산자를 사용할 수 있고, 추가로 String에 대해 + 연산자르르 사용할 수 있다.
...
### (1) 동등성 연산자: equals
코틀린이 == 연산자 호출을 equals메소드 호출로 컴파일한다는 사실을 배웠다. != 연산자를 사용하는 식도  equals 호출로 컴파일 된다.
...
![](https://3553248446-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5HOStxvx-Jr0fqZhyW%2F-MPFgRPxM8J4b7H4CZH3%2F-MPFhaVgBkNfAJPfLBVb%2F111.jpg?alt=media&token=9ccb0db6-f743-4a49-b96d-6737ac6035b5)
...
```kotlin
class Person(val name: String) {
ㅇㅇㅇㄴㅇㄴㄴㄴ	// emails을 사용하는 시점에 로딩 한다.
