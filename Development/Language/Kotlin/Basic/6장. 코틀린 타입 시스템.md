...
#### (1) NullPointerException 오류를 다루는 다른 방법
...
![](https://3553248446-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5HOStxvx-Jr0fqZhyW%2F-MOWr_c5B-t37Wgi3DOg%2F-MOWsehHV2lYFGYbT06d%2F1.jpg?alt=media&token=b69077b9-8d78-4d9a-815c-2c9c50322e63)
...
let은 수신객체를 이용해 작업을 한 후 마지막 줄을 return 할 때 사용한다. 

![](https://3553248446-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5HOStxvx-Jr0fqZhyW%2F-MOWr_c5B-t37Wgi3DOg%2F-MOWszlkpAS0vZuxjzsR%2F2.jpg?alt=media&token=5311ef81-4abb-4fbf-96f0-b38146bc651b)
...
## 6.2 Kotlin Primitive Type

#### (1) Primitive type : Int, Boolean 등
...
#### (2) Null이 될 수 있는 원시 타입 : Int? , Boolean? 등
...
Unit은 모든 기능을 갖는 일반적인 타입이며, void 와 달리 Unit을 타입 인자로 쓸 수 있다. Unit타입에 속한 값은 단 하나 뿐이며, 그 이름도 Unit이다. Unit 타입의 함수는 Unit 값을 묵시적으로 반환 한다. 이 두 특성은 제네릭 파라미터를 반환하는 함수를 오버라이드하면서 반환 타입으로 Unit을 쓸 때 유용하다.
...
![](https://3553248446-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5HOStxvx-Jr0fqZhyW%2F-MOWr_c5B-t37Wgi3DOg%2F-MOWtSeGwRjyOnVf1Qmf%2F3.jpg?alt=media&token=44d24166-19cd-41c8-85ec-d58f1f0d9e58)


#### (3) 코틀린 컬렉션과 자바
모든 코틀린 컬렉션은 그에 상응하는 자바 컬렉션 인터페이스의 인스턴스라는 점은 사실이다. 하지만 코틀린은 모든 자바 컬렉션 인터페이스마다 읽기 전용 인터페이스와 변경 가능한 인터페이스라는 두 가지 표현을 제공한다.

![](https://3553248446-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-M5HOStxvx-Jr0fqZhyW%2F-MOWr_c5B-t37Wgi3DOg%2F-MOWtUmzBAL-Yftt33_M%2F4.jpg?alt=media&token=859232ca-4c04-4153-a9df-aa92ff41adcf)
